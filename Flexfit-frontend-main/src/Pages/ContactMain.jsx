...
function ContactMain() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Example: Submit logic (can be replaced with actual API call or form handling)
    setShowToast(true);
  ...
  return (
    <>
      <section>
        ...
        <div className="bg-white py-[12rem] page-padding grid grid-cols-2 container gap-10 items-center md1000:grid-cols-1">
          ...
          <div className="md1000:w-[60%] md1000:flex md1000:flex-col md1000:mx-auto min800:w-[90%] min620:w-full">
            ...
            <p className="text-[16px] w-[95%] text-[#646464] font-medium my-[40px]">
              At Flexfit, we are dedicated to helping you achieve the body of
        ...
        {/* Custom Toast */}
        {showToast && (
          <div className="fixed top-10 right-10 bg-green-500 text-white border border-green-600 rounded-lg p-4 z-50">
            <p className="text-[#646464]"> Submitted successfully!</p>
            <button
              onClick={() => setShowToast(false)}
              className="text-[#646464] ml-2 focus:outline-none"
            >
              &#10005;
            </button>
          </div>
