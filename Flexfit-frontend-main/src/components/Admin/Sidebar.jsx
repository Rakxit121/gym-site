            ...
            <div className="sidebar flex flex-col fixed w-[30rem] min450:w-full h-[100vh] bg-white top-0 left-0 z-[9999999999] p-[45px] overflow-x-hidden">
                ...
                <div className="profile">
                    <Link to="/admin/settings">
                        <img src="https://cdn-icons-png.flaticon.com/512/16876/16876123.png" alt="admin" />
                    </Link>
                    <p>admin</p>
                    <p>admin@gmail.com</p>
                </div>
                    ...
                    <ul>
                        ...
                        <li>
                            <Link to="/admin/membership">
                                <p className='side_link' style={{ color: "black", display: 'flex', justifyContent: 'space-around', alignItems: 'center' }}>
                                    <img src="https://img.icons8.com/parakeet/48/group.png" alt="users" width="38" height="38" />
                                    Users
                                </p>
                            </Link>
                        </li>
                        <li>
                            <Link to="/admin/trainers">
                                <p className='side_link' style={{ color: "black", display: 'flex', justifyContent: 'space-around', alignItems: 'center' }}>
                                    <img src="https://img.icons8.com/external-flat-juicy-fish/60/external-gym-gym-life-flat-flat-juicy-fish-10.png" alt="trainers" width="38" height="38" />
                                    Trainers
                                </p>
                            </Link>
                        </li>
                        <li>
                            <Link to="/admin/payment">
                                <p className='side_link' style={{ color: "black", display: 'flex', justifyContent: 'space-around', alignItems: 'center' }}>
                                    <img src="https://img.icons8.com/cotton/64/card-in-use--v1.png" alt="payment" width="38" height="38" />
                                    Payment
                                </p>
                            </Link>
                        </li>
                        <li>
                            <Link to="/admin/settings">
                                <p className='side_link' style={{ color: "black", display: 'flex', justifyContent: 'space-around', alignItems: 'center' }}>
                                    <img src="https://img.icons8.com/plumpy/24/settings--v1.png" alt="setting" width="38" height="38" />
                                    Settings
                                </p>
                            </Link>
                        </li>
